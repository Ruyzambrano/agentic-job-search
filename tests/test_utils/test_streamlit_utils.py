...
from src.utils.streamlit_utils import iso_formatter, format_salary_as_range, filter_jobs_by_keywords, display_profile
...
def test_filter_jobs_by_keywords():
    ...
    mock_job.model_dump_json.return_value = '{"title": "Data Engineer", "tech_stack": ["Python"]}'
